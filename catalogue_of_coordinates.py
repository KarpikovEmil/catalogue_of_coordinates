...
class CatalogueOfCoordinates:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'CatalogueOfCoordinates_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Catalogue Of Coordinates')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/catalogue_of_coordinates/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Catalogue Of Coordinates'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Catalogue Of Coordinates'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = CatalogueOfCoordinatesDockWidget()
